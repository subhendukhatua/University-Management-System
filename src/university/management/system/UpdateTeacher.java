...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher(){
        ...
        //Roll no
        JLabel lblrollno= new JLabel("Eployee Id:");
        ...
        try{
            ...
            while(rs.next()){
                ...
                tfcourse.setText(rs.getString("education_qualification"));
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()== submit){
            ...
            try{
                ...
                String query = "update teacher set address= '"+address+"',phone = '"+phone+"',email = '"+email+"',education_qualification = '"+course+"',department = '"+branch+"' where empId = '"+empId+"'";
                Conn con = new Conn();
